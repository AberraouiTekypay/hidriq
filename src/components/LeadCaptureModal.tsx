              ...
              <div className="space-y-5 text-left">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    type="button"
                    onClick={handleClose}
                    className="px-6 py-2.5 rounded-full bg-teal-500 hover:bg-teal-400 text-slate-950 text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer"
                  >
                    Return to Site
                  </button>
                </div>
